<div align="center">
    ...
    <h1>Lux DAO Framework</h1>
    <strong>A modular, low cost and extensible set of contracts to build your DAO on Ethereum</strong>
</div>
<br>
<div align="center">
    <a href="https://github.com/luxdefi/dao/actions/workflows/test.yml">
        <img src="https://github.com/luxdefi/dao/actions/workflows/test.yml/badge.svg" alt="Tests">
    </a>
    <a href="https://github.com/luxdefi/dao/actions/workflows/slither.yml">
        <img src="https://github.com/luxdefi/dao/actions/workflows/slither.yml/badge.svg" alt="Slither">
    </a>
    <a href="https://codecov.io/gh/luxdefi/dao">
        <img src="https://codecov.io/gh/luxdefi/dao/branch/master/graph/badge.svg" alt="Coverage" >
    </a>
    <a href="https://www.npmjs.com/package/dao">
        <img src="https://img.shields.io/npm/v/dao.svg?logo=npm" alt="Slither">
    </a>
...
In the same `.env` file created under the `dao` folder, set the following environment variables:
...
# Copy that from the dao/build/contracts-goerli-YYYY-MM-DD-HH:mm:ss.json
